...
public enum ModBlocks {
	...
	BOP_LOG_STRIPPED(ConfigBlocksItems.enableStrippedLogs && ModsList.BIOMES_O_PLENTY.isLoaded(), new BlockStrippedBOPLog(LogCategory.CAT1, "bop_stripped_log", false, true)),
	BOP_LOG_STRIPPED2(ConfigBlocksItems.enableStrippedLogs && ModsList.BIOMES_O_PLENTY.isLoaded(), new BlockStrippedBOPLog(LogCategory.CAT2, "bop_stripped_log2", false, true)),
	BOP_LOG_STRIPPED3(ConfigBlocksItems.enableStrippedLogs && ModsList.BIOMES_O_PLENTY.isLoaded(), new BlockStrippedBOPLog(LogCategory.CAT3, "bop_stripped_log3", false, true)),
	BOP_LOG_STRIPPED4(ConfigBlocksItems.enableStrippedLogs && ModsList.BIOMES_O_PLENTY.isLoaded(), new BlockStrippedBOPLog(LogCategory.CAT4, "bop_stripped_log4", false, true)),
	BOP_WOOD(ConfigBlocksItems.enableStrippedLogs && ModsList.BIOMES_O_PLENTY.isLoaded(), new BlockStrippedBOPLog(LogCategory.CAT1, "bop_wood", true, false)),
	BOP_WOOD2(ConfigBlocksItems.enableStrippedLogs && ModsList.BIOMES_O_PLENTY.isLoaded(), new BlockStrippedBOPLog(LogCategory.CAT2, "bop_wood2", true, false)),
	BOP_WOOD3(ConfigBlocksItems.enableStrippedLogs && ModsList.BIOMES_O_PLENTY.isLoaded(), new BlockStrippedBOPLog(LogCategory.CAT3, "bop_wood3", true, false)),
	BOP_WOOD4(ConfigBlocksItems.enableStrippedLogs && ModsList.BIOMES_O_PLENTY.isLoaded(), new BlockStrippedBOPLog(LogCategory.CAT4, "bop_wood4", true, false)),
	BOP_WOOD_STRIPPED(ConfigBlocksItems.enableStrippedLogs && ModsList.BIOMES_O_PLENTY.isLoaded(), new BlockStrippedBOPLog(LogCategory.CAT1, "bop_stripped_wood", true, true)),
	BOP_WOOD_STRIPPED2(ConfigBlocksItems.enableStrippedLogs && ModsList.BIOMES_O_PLENTY.isLoaded(), new BlockStrippedBOPLog(LogCategory.CAT2, "bop_stripped_wood2", true, true)),
	BOP_WOOD_STRIPPED3(ConfigBlocksItems.enableStrippedLogs && ModsList.BIOMES_O_PLENTY.isLoaded(), new BlockStrippedBOPLog(LogCategory.CAT3, "bop_stripped_wood3", true, true)),
	BOP_WOOD_STRIPPED4(ConfigBlocksItems.enableStrippedLogs && ModsList.BIOMES_O_PLENTY.isLoaded(), new BlockStrippedBOPLog(LogCategory.CAT4, "bop_stripped_wood4", true, true)),
